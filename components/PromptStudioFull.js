// components/PromptStudioFull.js — FULL KONFIG-STUDIO (med DB-lagring)
// Redigerer og lagrer persona per bot. Bruker Supabase via /api/persona/*.
  ...
  return (
    <section className="bg-white rounded-2xl shadow p-5">
      ...
      <p className="text-xs text-gray-500 mb-4">
        Endrer **bot-konfig** permanent (lagres i DB). Bruk “preview” under for trygg eksperimentering uten lagring.
      </p>
